...
│   │   │                       # StatsCard (role-aware: GuestStats — activity chips + monthly bar chart; AdminStats — user stats chips + registrations bar chart),
