                ...
                {selectedReleases.map((release) => {
                  ...
                  return (
                    <button
                      ...
                      className="flex items-center gap-3 py-2.5 w-full text-left rounded-lg px-1 -mx-1 transition-colors cursor-pointer hover:bg-cream-400 dark:hover:bg-gray-700/60"
                    >
