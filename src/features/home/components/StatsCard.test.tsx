...
jest.mock('recharts', () => ({
  ...
  Area: () => null, XAxis: () => null, YAxis: () => null, Tooltip: () => null,
}))
...
describe('StatsCard — guest', () => {
  ...
  it('shows dash for avg rating when no ratings', () => {
    renderCard()
    expect(screen.getByText('—')).toBeInTheDocument()
  })

  it('shows avg rating with star suffix when ratings exist', () => {
